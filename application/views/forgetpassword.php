...
<head>
    ...
    <title><?= output($siteinfo[0]['s_companyname'] ?? 'Vehicle Management System'); ?> | Forget Password</title>
...
<div class="login-container">
   ...
   <div class="card" style="max-width: 400px; margin: auto; border-radius: 10px; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1);">
    <div class="card-body login-card-body">
        ...
        <form action="<?= base_url().'login/forgetpassword_action'; ?>" method="post">
            <div class="input-group mb-3">
                <input type="text" name="username" required class="form-control" placeholder="Enter Username / Email" aria-label="Username" style="border-radius: 5px;">
