...
<head>
    ...
    <title><?= output($siteinfo[0]['s_companyname'] ?? 'Vehicle Management System'); ?> | Log In</title>
    ...
    <div class="card-body login-card-body">
        ...
        <form action="<?= base_url().'login/login_action'; ?>" method="post">
            <div class="input-group mb-3">
                <input type="text" name="username" required class="form-control" placeholder="Email" autofocus>
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <button type="submit" class="btn btn-primary btn-block" style="border-radius: 5px;">Sign In</button>
                </div>
            </div>
        </form>
    </div>
