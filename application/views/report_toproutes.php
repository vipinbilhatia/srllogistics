<div class="content-header">
   <div class="container-fluid">
      <div class="row mb-2">
         <div class="col-sm-6">
            <h1 class="m-0 text-dark">Top Routes Report
            </h1>
         </div>
         <!-- /.col -->
         <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
               ...
               <li class="breadcrumb-item active">Top Routes Report</li>
            </ol>
         </div>
         <!-- /.col -->
      </div>
...
<section class="content">
   <div class="container-fluid">
      <form method="post" id="booking_report" class="card basicvalidation" action="<?php echo base_url();?>reports/toproutes">
         <div class="card-body">
            <div class="row">
               <div class="col-md-3">
                  <div class="row">
            ...
            <?php } } ?>
               ...
               <input type="hidden" id="toproutes" name="toproutes" value="1">
               <div class="col-md-2">
        ...
        <div class="card-body p-0">
         ...
         <div class="table-responsive">
                    <table  class="datatableexport table card-table table-vcenter">
                     ...
                     <?php
                           $count=1;
                           foreach($toproutes as $toproutess){
                           ?>
                        <tr>
                           <td> <?php echo output($count); $count++; ?></td>
                           <td> <?php echo $toproutess['route']?ucfirst($toproutess['route']):''; ?></td>
                             <td><?php echo ucfirst($toproutess['total_amount']); ?></td>
