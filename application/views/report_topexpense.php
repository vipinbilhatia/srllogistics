<div class="content-header">
   <div class="container-fluid">
      <div class="row mb-2">
         <div class="col-sm-6">
            <h1 class="m-0 text-dark">Top Expense Report
            </h1>
         </div>
         <!-- /.col -->
         <div class="col-sm-6">
...
<section class="content">
   <div class="container-fluid">
      <form method="post" id="booking_report" class="card basicvalidation" action="<?php echo base_url();?>reports/topexpense">
         <div class="card-body">
            <div class="row">
               <div class="col-md-3">
                  <div class="row">
            ...
            <?php } } ?>
               ...
               <input type="hidden" id="topexpense" name="topexpense" value="1">
               <div class="col-md-2">
