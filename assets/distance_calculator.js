...
'use strict';
 google.maps.event.addDomListener(window, 'load', function () {
            ...
            google.maps.event.addListener(places, 'place_changed', function () {
                ...
                unit = (document.getElementById('mapunit').value=='miles')?'N':'K';
                distance(document.getElementById("t_trip_fromlat").value, document.getElementById("t_trip_fromlog").value, latitude, longitude, unit);
            });
