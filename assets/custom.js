    ...
    $('.preventDefault').click(function(event) {
     ...
     $.validator.setDefaults({
       ...
       $("#v_registration_no").on('keypress change', function(event) {
        ...
        setTimeout(function() {
            var container = $('<div class="dt-container"></div>');
            container.append($('.dt-buttons'));
            container.append($('#DataTables_Table_0_filter'));
            $('#DataTables_Table_0_wrapper').prepend(container);
        }, 10);
